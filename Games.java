...
public class Games {
    static String[] gameChoices = { "SpendingDraft", "JavaPong" };
    ...
    public static Game getGameChoice() {
        ...
        if (gameString.equals("SpendingDraft")) {
            return (Game) new SpendingDraft.SpendingDraft();
        } else if (gameString.equals("JavaPong")) {
            return (Game) new JavaPong.Main();
        } else {
            return null;
        }
